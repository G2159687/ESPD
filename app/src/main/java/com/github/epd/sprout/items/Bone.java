...
public class Bone extends Item {
	...
	private static final String TXT_PREVENTING = Messages.get(Bone.class, "prevent");
	private static final String TXT_PREVENTING2 = Messages.get(Bone.class, "prevent2");
