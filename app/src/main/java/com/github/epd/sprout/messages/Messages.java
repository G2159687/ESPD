...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.github.epd.sprout.messages.actors.actors",
			"com.github.epd.sprout.messages.items.items",
			"com.github.epd.sprout.messages.levels.levels",
			"com.github.epd.sprout.messages.plants.plants",
			"com.github.epd.sprout.messages.scenes.scenes",
			"com.github.epd.sprout.messages.ui.ui",
			"com.github.epd.sprout.messages.windows.windows",
			"com.github.epd.sprout.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object... args) {
		String key;
		if (c != null) {
			key = c.getName().replace("com.github.epd.sprout.", "");
			key += "." + k;
		} else
			key = k;
