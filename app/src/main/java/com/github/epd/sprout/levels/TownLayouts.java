...
public class TownLayouts {
	...
	private static final int Y = Terrain.EMPTY; //for readability
	...
	public static final int[] TOWN_LAYOUT =	{     
		...
		M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 
		M, 	M, 	M, 	M, 	Y, 	M, 	T, 	M, 	M, 	M, 	M, 	M, 	Y, 	Y, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	Y, 	M, 	Y, 	W, 	W, 	W, 	W, 	W, 	W, 	W, 	W, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 	M, 
		...
		M, 	M, 	W, 	F, 	F, 	F, 	F, 	W, 	T, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	W, 	O, 	O, 	O, 	W, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	M, 	M, 
		M, 	M, 	W, 	F, 	F, 	F, 	F, 	T, 	T, 	T, 	M, 	M, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	W, 	B, 	B, 	B, 	W, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	M, 	M, 	M, 
		M, 	M, 	W, 	F, 	F, 	F, 	F, 	T, 	T, 	T, 	M, 	M, 	M, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	W, 	W, 	W, 	W, 	W, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	Y, 	M, 	M, 	M, 	M, 
