...
public class AncientCoin extends Item {
	...
	private static final String TXT_PREVENTING = Messages.get(AncientCoin.class, "prevent");
	private static final String TXT_PREVENTING2 = Messages.get(AncientCoin.class, "prevent2");


	public static final float TIME_TO_USE = 1;

	public static final String AC_PORT = Messages.get(AncientCoin.class, "ac");
